...
public abstract class Hit {
    ...
    @Parameter(format = Parameter.FORMAT_TEXT, required = true, name = MeasurementProtocol.TRACKING_ID)
    public String tracking_id;

    @Parameter(format = Parameter.FORMAT_TEXT, required = true, name = MeasurementProtocol.CLIENT_ID)
    ...
    @Parameter(format = Parameter.FORMAT_INTEGER, required = false, name = MeasurementProtocol.QUEUE_TIME)
    ...
    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.CAMPAIGN_NAME)
    public String campaign_name;

    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.CAMPAIGN_SOURCE)
    public String campaign_source;

    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.CAMPAIGN_MEDIUM)
    public String campaign_medium;

    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.CAMPAIGN_KEYWORD)
    public String campaign_keyword;

    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.CAMPAIGN_CONTENT)
    public String campaign_content;

    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.CAMPAIGN_ID)
    public String campaign_id;

    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.ADWORDS_ID)
    public String adwords_id;

    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.DISPLAY_ADS_ID)
    ...
    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.VIEWPORT_SIZE)
    public String viewport_size;

    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.DOCUMENT_ENCODING)
    public String document_encoding;

    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.SCREEN_COLORS)
    public String screen_colors;

    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.USER_LANGUAGE)
    public String user_language;

    @Parameter(format = Parameter.FORMAT_BOOLEAN, required = false, name = MeasurementProtocol.JAVA_ENABLED)
    public Boolean java_enabled;

    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.FLASH_VERSION)
    ...
    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.DOCUMENT_HOST_NAME)
    public String document_host_name;

    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.DOCUMENT_PATH)
    public String document_path;

    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.DOCUMENT_TITLE)
    public String document_title;

    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.CONTENT_DESCRIPTION)
    public String content_description;

    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.LINK_ID)
    ...
    @Parameter(format = Parameter.FORMAT_TEXT, required = false, name = MeasurementProtocol.EXPERIMENT_VARIANT)
